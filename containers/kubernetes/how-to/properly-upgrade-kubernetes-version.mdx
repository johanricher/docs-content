...
First, we will ensure the newer Kapsule version properly handles your workload. We have a compatibility matrix
...
Managed ingress controllers are deprecated since the minor release 1.24, we provide the feature EasyDeploy instead to set up an ingress controller.
